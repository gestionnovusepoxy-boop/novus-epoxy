...
<p style="text-align:center;color:#64748b;font-size:12px;margin:0 0 16px;">Virement Interac uniquement — envoyez au 581-307-5983 ou gestionnovusepoxy@gmail.com</p>
...
<tr style="border-bottom:1px solid #e2e8f0;"><td style="padding:6px 0;color:#64748b;font-size:14px;">Prix/pi²</td><td style="padding:6px 0;text-align:right;font-size:14px;">${formatMoney(Number(quote.prix_pied_carre))}</td></tr>${quoteExtras.length > 0 ? quoteExtras.map((ex: Record<string, unknown>) => `\n<tr style="border-bottom:1px solid #e2e8f0;"><td style="padding:6px 0;color:#64748b;font-size:14px;">${escapeHtml(ex.description as string)}${Number(ex.quantite) > 1 ? ` x${ex.quantite}` : ''}</td><td style="padding:6px 0;text-align:right;font-size:14px;">${formatMoney(Number(ex.sous_total))}</td></tr>`).join('') : ''}`)}
${Number(quote.rabais_pct) > 0 ? `<tr style="border-bottom:1px solid #e2e8f0;"><td style="padding:6px 0;color:#16a34a;font-size:14px;font-weight:600;">Rabais ${quote.rabais_pct}%</td><td style="padding:6px 0;text-align:right;font-size:14px;color:#16a34a;font-weight:600;">-${formatMoney(Number(quote.rabais_montant))}</td></tr>` : ''}
...
<p style="margin:0;color:#94a3b8;font-size:11px;">Virement Interac : 581-307-5983 ou gestionnovusepoxy@gmail.com</p>
</div>
